...
useEffect(() => {
  ...
  return (
    <>
      <Seo
        title={"Training - Zimcrest Technologies"}
        description="At Zimcrest, we're dedicated to transforming ideas into impactful digital solutions. As a leading technology company, we specialize in offering internship opportunities that provide hands-on experience and cater to the unique needs of aspiring professionals across various industries."
      />
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <div className="relative flex flex-col items-center justify-center px-4 py-24 mx-auto text-center max-w-7xl sm:py-32 sm:px-6 lg:px-8">
            ...
            <p className="max-w-xl mt-6 text-base text-indigo-100 md:text-xl ">
              Elevate your tech skills with our industry-focused training
              courses. Learn from experts and gain practical experience that
              employers value.
            </p>
            <div className="mt-10">
              <a
          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="max-w-3xl mx-auto mt-4 text-base leading-tight text-center text-gray-500 md:text-lg">
                Explore our comprehensive range of tech training programs
                designed to meet industry demands and advance your career.
              </p>
            </div>
            <div className="grid w-full grid-cols-1 gap-4 mt-12 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="overflow-hidden transition-shadow duration-300 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-600 md:text-base">
                      Learn to analyze complex datasets, build predictive
                      models, and extract actionable insights using
              ...
              <div className="overflow-hidden transition-shadow duration-300 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-600 md:text-base">
                      Develop skills to protect systems and networks from
                      digital attacks. Learn threat detection, vulnerability
              ...
              <div className="overflow-hidden transition-shadow duration-300 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-600 md:text-base">
                      Create intuitive, engaging user experiences and
                      interfaces. Master design thinking, wireframing,
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-600 md:text-base">
                      ...
                      strategies. Master SEO, content marketing, social media,
                      and analytics.
                    </p>
                    <div className="mt-4">
                      <div className="flex items-center text-sm text-gray-500">
                      ...
                      <div className="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2">
                        <div>
                          ...
                          <p className="mt-2 text-gray-600">
                            ...
                            responsive web applications from scratch. You'll
                            learn modern frameworks and best practices used in
                            the industry today.
                          </p>
                    ...
                    <div className="p-8">
                      ...
                      <div className="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2">
                        <div>
                          ...
                          <p className="mt-2 text-gray-600">
                            Learn to design intuitive digital experiences
                            through comprehensive training in user interface and
                            user experience design principles, tools, and
                            methodologies.
                          </p>
                          <div className="mt-6 space-y-4">
                            <div className="flex items-center">
                    ...
                    <div className="p-8">
                      ...
                      <div className="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2">
                        <div>
                          ...
                          <p className="mt-2 text-gray-600">
                            Learn comprehensive digital marketing strategies,
                            from SEO and content marketing to social media
                            management and analytics, preparing you for a career
                            in modern marketing.
                          </p>
                          <div className="mt-6 space-y-4">
                            <div className="flex items-center">
          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-4 mt-16 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="p-8 bg-white rounded-lg shadow-sm">
                ...
                <p className="mt-2 text-base text-gray-500">
                  Get support with resume building, interview preparation, and
                  job search strategies from our career services team.
                </p>
              </div>
              <div className="p-8 bg-white rounded-lg shadow-sm">
                <div className="flex items-center justify-center w-12 h-12 mx-auto text-white rounded-md bg-primary-600">
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="mt-1 text-sm text-indigo-700">
                            ...
                            processed. We never share your details with third
                            parties.
                          </p>
                        </div>
                      </div>
            ...
            <div className="grid grid-cols-1 gap-4 mt-12 md:grid-cols-3">
              ...
              <div className="p-8 bg-white rounded-lg shadow-sm">
                ...
                <p className="italic text-gray-600">
                  ...
                  transformed my career. The curriculum was current, hands-on,
                  and mapped to real industry tooling. Barely a month after
              ...
              <div className="p-8 bg-white rounded-lg shadow-sm">
                ...
                <p className="italic text-gray-600">
                  ...
                  digital-product design. The UI/UX track at ZimcrestTech gave
                  me exactly what I needed—intense practice, portfolio-ready
                  projects, and direct mentoring. Thanks to the career-support
                  sessions, I now craft user-centred experiences at
                  Flutterwave.”
                </p>
                <div className="flex items-center mt-6">
                  <div className="flex text-yellow-400">
